...
if ($MsiPath) {
    ...
    Write-Host "[SUCCESS] MSI creado exitosamente: $($MsiPath.Name) ($MsiSize MB)" -ForegroundColor Green
    
    # Mostrar informacion del MSI
    Write-Host "Informacion del MSI:" -ForegroundColor Yellow
    ...
    Write-Host "[ERROR] No se encontro el archivo MSI" -ForegroundColor Red
